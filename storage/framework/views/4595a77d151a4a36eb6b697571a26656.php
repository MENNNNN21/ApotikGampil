    ...
    <div class="row g-4">
        ...
        <div class="col-sm-6 col-lg-3">
            <div class="card h-100 border-0 shadow-sm">
                <a href="<?php echo e(route('produk.show', $obat->id)); ?>" style="text-decoration: none; color: inherit;">
                    <img src="<?php echo e(asset('storage/' . $obat->gambar)); ?>" class="card-img-top" alt="<?php echo e($obat->nama); ?>">
                    <div class="card-body">
                        <h5 class="card-title"><?php echo e($obat->nama); ?></h5>
                        <p class="card-text text-muted small"><?php echo e(Str::limit($obat->deskripsi, 50)); ?></p>
                        <div class="d-flex justify-content-between align-items-center">
                            <span class="fw-bold text-success">Rp <?php echo e(number_format($obat->harga, 0, ',', '.')); ?></span>
                    </a>
                            <!-- Form POST untuk tombol Beli -->
                           <form action="<?php echo e(route('produk.addToCart', ['id' => $obat->id])); ?>" method="POST" style="margin:0;">
    <?php echo csrf_field(); ?>
    <input type="hidden" name="produk_id" value="<?php echo e($obat->id); ?>">
...
<?php /**PATH C:\xampp\htdocs\ApotikGampil\resources\views/produk/index.blade.php ENDPATH**/ ?>